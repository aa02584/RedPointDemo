package com.lzx.redpoint.widgets;
...
/**
 * Created by lizhixin on 2017/1/20.
 */

public class RedPointView extends FrameLayout {
    private PointF mStartPoint, mCurPoint; //mStartPoint表示起始圆心位置，mCurPoint是当前手指的位置
...
//        exploredImageView.setImageResource(Color.RED);
